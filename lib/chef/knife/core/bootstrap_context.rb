    ...
    module Core
      ...
      class BootstrapContext
        ...
        def bootstrap_environment
          ...
          # TODO: @chef_config picks up @config's environment setting, even when
          ...
          @config[:environment] or
            (@config[:first_boot_attributes] and @config[:first_boot_attributes][:environment]) or
            @chef_config[:environment] or
            '_default'
        end
